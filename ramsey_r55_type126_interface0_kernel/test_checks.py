...
def cohort(upstream):
    ...
    expected = [(0, 126, j, k) for j in range(29) for k in range(12)]
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='r55-kernel-controls-') as directory:
        ...
        for key in [(1,126,0,0), (0,62,0,0), (0,126,29,0), (0,126,0,12), (0,126,-1,0)]:
            try:
        ...
        raw = audit.matrix(inputs, cert, (0,126,0,0))
