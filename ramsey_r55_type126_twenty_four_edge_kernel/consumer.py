...
def main():
    ...
    result = {'status': 'VERIFIED_COMPLETE_TWENTY_FOUR_EDGE_TYPE126_DENSITY116_EXCLUSION',
              'complete_cases': 348, 'covered_original_cases': 696, 'newly_excluded_original_cases': 348, 'valid_local_fillings': 995, 'interfaces': [10, 11], 'kernel_vertices': 40,
              'physical_free_edges': 413, 'kernel_edge_variables': 296,
