...
def main():
    ...
    result = {'status': 'VERIFIED_COMPLETE_CONSENSUS_TYPE126_DENSITY116_EXCLUSION',
              'complete_cases': 348, 'covered_original_cases': 696, 'valid_local_fillings': 110, 'interfaces': [10, 12], 'kernel_vertices': 40,
              'physical_free_edges': 401, 'kernel_edge_variables': 284,
