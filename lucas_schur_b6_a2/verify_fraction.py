#!/usr/bin/env python3
"""Standard-library Fraction rebuild of the width-six remainder certificate."""
...
EXPECTED_CERTIFICATE_SHA256 = "bf6aa6ac2e9bb155677d9b5a21b0525d8c3a82e51aecf89ead8f0dc6d582015b"
        ...
        for quantity in ("A", "C"):
            ...
            for left, right in zip(ordered, ordered[1:]):
                ...
                if left[0] == 0 and right[0] == 0:
                    # Evaluation at t=T_START represents the whole constant
                    # cell only because all active partition arguments have
                    # zero t-slope. Keep that universal bridge executable.
