#!/usr/bin/env python3
"""Exact complete degree/triangle-conditioned P4 and global deficiency separator."""
import argparse
...
def global_star_rows(point):
    ...
    return {'global_star_rows':count,'global_star_rows_per_anchor':by_anchor,
            ...
            'total_rows_without_redundant_anchor_zero_rows':25365692}
...
def deficiency_separator(point,path):
    ...
    require(gap>0,'strict global deficiency separator')
    return {'deficiency_first_moment':'260','deficiency_second_moment':str(F(sum_a2,point.D)),
            'deficiency_second_moment_upper_bound':1576,'deficiency_separator_gap':str(F(gap,point.D)),
...
def main():
    ...
    result={'status':'EXACT_COMPLETE_DEGREE_TRIANGLE_P4_SURVIVOR',
            ...
            **conditioned_degrees(point,args.degree_separator),**triangle_rows(point),**deficiency_separator(point,args.deficiency_separator)}
