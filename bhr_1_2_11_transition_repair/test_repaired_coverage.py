...
class RepairedCoverageTests(unittest.TestCase):
    def test_repaired_coverage_counts(self) -> None:
        ...
        self.assertEqual(summary["after_target_orthant"], 8105)
        self.assertEqual(summary["residual_symbolic_patterns"], 1439)
    ...
    def test_tampered_target_orthant_is_rejected(self) -> None:
        data = json.loads((HERE / "target_orthant_certificate.json").read_text())
