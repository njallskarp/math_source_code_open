...
def cohort(upstream, classification):
    ...
    expected = [(7, 62, j, k) for j in range(1697) for k in range(2)]
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='r55-kernel-controls-') as directory:
        ...
        for key in [(6,62,0,0), (7,126,0,0), (7,62,1697,0), (7,62,0,2), (7,62,-1,0), (7,62,False,0), (7.0,62,0,0)]:
            try:
        ...
        raw = audit.matrix(inputs, cert, (7,62,0,0))
