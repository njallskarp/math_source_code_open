...
def main():
    ...
    result = {'status': 'VERIFIED_COMPLETE_SIXTEEN_EDGE_TYPE126_DENSITY116_EXCLUSION',
              'complete_cases': 348, 'covered_original_cases': 696, 'valid_local_fillings': 181, 'interfaces': [3, 4], 'kernel_vertices': 40,
              'physical_free_edges': 405, 'kernel_edge_variables': 288,
