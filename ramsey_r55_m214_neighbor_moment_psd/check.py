#!/usr/bin/env python3
"""Exact complete T point with full neighbor-count moment positivity."""
import argparse
...
def star_square(point,path):
    ...
    require(5*value < -point.D,'strict negative star square below -1/5')
    return {'star_square_center':h,'star_square_neighbors':neighbors,'star_square_offset':offset,
            ...
            'star_square_value':str(F(value,point.D)),'star_square_strict_upper_bound':'-1/5',
...
def main():
    ...
    result={'status':'EXACT_COMPLETE_NEIGHBOR_MOMENT_PSD_SURVIVOR',
            ...
            **conditioned_degrees(point,args.degree_separator),**triangle_rows(point),**deficiency_bound(point,args.deficiency_separator),**neighbor_matrix(point),**star_square(point,args.square)}
