#!/usr/bin/env python3
"""Regenerate the complete retained base and check the integral-selector P4 point."""
import argparse
import hashlib
import json
...
def main():
    ...
    controls=run(HERE/'controls.py','--links',work/'anchor-links.opbpart','--forbidden',work/'forbidden.opbpart')
    ...
    result=run(HERE/'check.py','--certificate',HERE/'certificate.json','--opb',paths[3323],'--links',work/'anchor-links.opbpart','--forbidden',work/'forbidden.opbpart')
