#!/usr/bin/env python3
"""Regenerate the base, verify the all-star point and strict degree separator."""
import argparse
import hashlib
import json
...
def main():
    ...
    controls=run(HERE/'controls.py','--links',work/'anchor-links.opbpart','--forbidden',work/'forbidden.opbpart','--degree-separator',work/'degree-separator.opbpart')
    ...
    result=run(HERE/'check.py','--certificate',HERE/'certificate.json','--opb',paths[3323],'--links',work/'anchor-links.opbpart','--forbidden',work/'forbidden.opbpart','--degree-separator',work/'degree-separator.opbpart')
