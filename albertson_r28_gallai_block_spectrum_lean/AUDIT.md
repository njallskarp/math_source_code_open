...
blocks already give one atom of size `u`.  The remaining graph-theoretic act
of extracting these blocks is an explicit trust-boundary item.
...
Lean theorem:
`no_spectrum_budget50_between_609_615_with_unique25`.
...
Lean theorems:
`no_spectrum_budget49_between_582_591` and
`no_spectrum_budget48_between_560_569`.
