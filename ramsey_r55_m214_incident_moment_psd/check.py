#!/usr/bin/env python3
"""Exact complete V point with every incident-edge moment matrix positive semidefinite."""
import argparse
...
def mixed_square(point,path):
    ...
    require(30*value < -point.D,'complete V strictly separated below -1/30')
    return {'mixed_square_center':29,'mixed_square_remote_edge':[2,8],'mixed_square_polynomial':'2*a_29+x_2_8-14',
            'mixed_square_terms':270,'mixed_square_rhs':436,'mixed_square_strict_upper_bound':'-1/30',
...
def main():
    ...
    result={'status':'EXACT_COMPLETE_INCIDENT_MOMENT_PSD_SURVIVOR',
            ...
            **conditioned_degrees(point,args.degree_separator),**triangle_rows(point),**deficiency_bound(point,args.deficiency_separator),**neighbor_matrix(point),**incident_matrices(point),**star_square(point,args.square),**mixed_square(point,args.mixed_square)}
