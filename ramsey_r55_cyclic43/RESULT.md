...
### Radius-five exclusion tube around the optimum bridge
...
distance at least six from every bridge vertex.
...
Hence the number of distinct colorings in the radius-five tube is

$$
\sum_{A\subseteq[15]}\ \sum_{j=0}^{5-d(A)}\binom{888}{j}
=78{,}403{,}224{,}656{,}596.
$$

A single radius-five ball in the 903-dimensional coloring cube has
$4{,}975{,}760{,}682{,}488$ vertices, so the tube covers about 15.76 times that
volume after overlaps are removed. The 16 searches considered 8,547,751
candidate branches in total. Full per-center counts and the overlap certificate
are in [`bridge-tube-radius5.json`](bridge-tube-radius5.json), generated by
...
f75b815b6746fe95f011f1d9c4e0a6dc5add124a27139c44af63b14507f317b5  bridge-tube-radius5.json
```
